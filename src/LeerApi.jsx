...
const LeerApi = () => {
  ...
  const consultarInformacion = async () => {
    ...
    setInfo(data) // actualiza estado con todo el contenido de data que devuelve api
    //setInfo(`${data[0].name} - ${data[0].email}`); // con setInfo actualizamos el estado de info
  ...
  return (
    <div className="App">
      <h1>Contenido Lista de Users</h1>
      <ul>
            {info.map((dato) => (
                            <li key={dato.id}>
